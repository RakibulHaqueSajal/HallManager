...
<html lang="en">
  <head>
    ...
    <title>Shahid President Ziaur Rahman Hall</title>
    ...
    <div class="jumbotron">
        <div class="container">
            <div id="details" class="animated fadeInLeft">
                ...
                <p>Shahid President Ziaur Rahman Hall</p>
            </div>
        </div>
            ...
            <div class="col-md-4 animated fadeInRightBig">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <br>
                        <p style="text-align: justify;">Shahid President Ziaur Rahman Hall is one of the Desired hall of the student of Ruet. It was Established early in this century. It is 5 storied building having capacity of around 350 student.</p>
                    </div>
                </div>
