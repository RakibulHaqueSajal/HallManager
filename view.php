...
<html lang="en">
    ...
    <body>
        ...
        ?>
        <button class="btn btn-danger"><a href="view.php">Home</a></button>
                        ...
                        <?php
                              ...
                              if(mysqli_num_rows($run) > 0){
                                  while($row = mysqli_fetch_array($run)){
                                      ...
                                      echo "<button class='btn btn-default' style='background-color:lightblue; margin-right: 5px; margin-top:5px; margin-bottom:5px; margin-left:5px;'><a class='dropdown-item' href='view.php?hall=".$u_hall_id."&floor=".$floor_id."'>$floor_name</a></button>";
                                  }
                              }
                              else{
                        ...
                        <?php
                              ...
                              if(mysqli_num_rows($run) > 0){
                                  while($row = mysqli_fetch_array($run)){
                                      ...
                                      $room_id = $row['room_no'];
                                      echo "<button class='btn btn-default' style='background-color:lightblue; margin-right: 5px;  margin-top:5px; margin-bottom:5px; margin-left:5px;'><a class='dropdown-item' href='view.php?hall=".$u_hall_id."&floor=".$u_floor_id."&room=".$room_id."'>$room_name</a></button>";
                                  }
                              }
                              else{
                        ...
                        <?php
                              ...
                              if(mysqli_num_rows($stud_run) > 0){
                                  while($row = mysqli_fetch_array($stud_run)){
                                      ...
                                      echo "<a href='stud_details.php?id=$stud_id'>$stud_name</a><br>";
                                  }
                              }
                              else{
