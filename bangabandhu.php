...
<html lang="en">
  <head>
    ...
    <title>Bangabondhu Sheikh Mujibur Rahman Hall</title>
    ...
    <div class="jumbotron">
        <div class="container">
            <div id="details" class="animated fadeInLeft">
                ...
                <p>Bangabondhu Sheikh Mujibur Rahman Hall</p>
            </div>
        </div>
            ...
            <div class="col-md-4 animated fadeInRightBig">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <br>
                        <p style="text-align: justify;">Bangabondhu Sheikh Mujibur Rahman Hall is a two storied building with a capacity of having 150 -200 students. It was named after the father of the nation BangaBandhu Sheikh Mujibar Rahman.</p>
                    </div>
                </div>
