...
<html lang="en">
  <head>
    ...
    <title>Shahid Abdul Hamid Hall</title>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="index.html"><i class="fa fa-sign-in"></i> Sign In</a></li>
            <li class="dropdown">
            ...
            <div class="col-md-4 animated fadeInRightBig">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <br>
                        <p style="text-align: justify;">Shahid Abdul Hamid Hall is a four storied building with a capacity of having 200-250 students. It was named after a freedom fighter named hamid.</p>
                    </div>
                </div>
