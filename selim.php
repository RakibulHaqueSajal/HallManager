...
<html lang="en">
  <head>
    ...
    <title>Shahid Lieutenant Salim hall</title>
    ...
    <div class="jumbotron">
        <div class="container">
            <div id="details" class="animated fadeInLeft">
                ...
                <p>Shahid Lieutenant Salim hall</p>
            </div>
        </div>
            ...
            <div class="col-md-4 animated fadeInRightBig">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <br>
                        <p style="text-align: justify;">Shahid Lieutenant Salim hall is a four storied building with a capacity of having 300-350 students. It was named after a freedom fighter named selim.</p>
                    </div>
                </div>
