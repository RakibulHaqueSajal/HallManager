...
<html lang="en">
  <head>
    ...
    <title>Shahid Shahidul Islam Hall</title>
            ...
            <div class="col-md-4 animated fadeInRightBig">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <br>
                        <p style="text-align: justify;">Shahid Shahidul Islam Hall is a four storied building with a capacity of having 200-250 students.It was named after a freedom fighter named Shaheed.</p>
                    </div>
                </div>
