...
<html lang="en">
  <head>
    ...
    <title>Deshratna Sheikh Hasina Hall</title>
    ...
    <div class="jumbotron">
        <div class="container">
            <div id="details" class="animated fadeInLeft">
                ...
                <p>Deshratna Sheikh Hasina Hall</p>
            </div>
        </div>
            ...
            <div class="col-md-4 animated fadeInRightBig">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <br>
                        <p style="text-align: justify;">Deshratna Sheikh Hasina Hall is a five storied building with a capacity of having 200-250 students. It is only for female student .it was named after the prime minister of our country Sheikh Hasina.</p>
                    </div>
                </div>
